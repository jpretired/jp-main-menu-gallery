...
return new class extends AbstractModule implements ModuleCustomInterface, ModuleMenuInterface, ModuleGlobalInterface
{
    ...
    {
        return I18N::translate('Main menu gallery');
    }
    ...
    public function description(): string
    {
        ...
        return I18N::translate('Add an extra mainmenu item as a link to gallery.');
    }
    ...
    {
        return 'https://github.com/jpretired/jp-main-menu-gallery/releases/latest';
    }
    ...
    public function getMenu(Tree $tree): ?Menu
    {
        ...
        $url = 'https://galerie.jprodina.cz';
        $menu_title = I18N::translate('Gallery');

        return new Menu($menu_title, e($url), 'jp-main-menu-gallery');
    }
    ...
    {
        $url = $this->assetUrl('css/main-menu-gallery.css');
